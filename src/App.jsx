        ...
        <main className="mx-auto mt-10 max-w-7xl space-y-24">
          <section id="home" className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] xl:items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.94 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.9 }} className="relative flex flex-col items-center justify-center gap-6 rounded-[40px] border border-slate-200/80 dark:border-white/10 bg-white/40 dark:bg-white/10 p-6 shadow-glass backdrop-blur-xl">
              ...
              <div className="relative flex h-[min(24rem,80vw)] w-[min(24rem,80vw)] items-center justify-center rounded-[36px] border border-slate-200/50 dark:border-white/15 bg-white/40 dark:bg-slate-950/70 shadow-2xl shadow-slate-950/30">
                <div className="h-[min(20rem,70vw)] w-[min(20rem,70vw)] rounded-[32px] bg-gradient-to-br from-indigo-500 to-cyan-400 p-1 shadow-lg">
                  <motion.div 
                    whileHover={{ scale: 1.03 }}
                    className="h-full w-full rounded-[28px] bg-slate-900 overflow-hidden relative group"
                  >
                    <svg viewBox="0 0 200 200" className="h-full w-full">
                      ...
                      <rect width="200" height="200" fill="url(#avatarGrad)" opacity="0.8" />
                      ...
                      <circle cx="100" cy="190" r="80" fill="#111827" opacity="0.9" />
                      <circle cx="100" cy="90" r="38" fill="#111827" stroke="rgba(255,255,255,0.1)" strokeWidth="2" />
                      
                      <path d="M62 90 C62 50, 138 50, 138 90" fill="none" stroke="#6366F1" strokeWidth="4" opacity="0.6" />
                      
                      <path d="M50 170 L150 170 L140 135 L60 135 Z" fill="#1F2937" stroke="#374151" strokeWidth="2" />
                      <path d="M56 165 L144 165 L136 140 L64 140 Z" fill="#059669" opacity="0.15" className="animate-pulse" />
                      <path d="M35 170 L165 170 L175 190 L25 190 Z" fill="#111827" stroke="#374151" strokeWidth="2" />
                      <circle cx="100" cy="152" r="5" fill="#E5E7EB" opacity="0.9" />
                      <path d="M99 145 C101 145, 101 148, 99 148 Z" fill="#E5E7EB" opacity="0.9" />

                      <rect x="76" y="84" width="20" height="12" rx="3" fill="none" stroke="#22D3EE" strokeWidth="2.5" className="group-hover:stroke-fuchsia-400 transition-colors duration-300" />
                      <rect x="104" y="84" width="20" height="12" rx="3" fill="none" stroke="#22D3EE" strokeWidth="2.5" className="group-hover:stroke-fuchsia-400 transition-colors duration-300" />
                      <line x1="96" y1="90" x2="104" y2="90" stroke="#22D3EE" strokeWidth="2.5" className="group-hover:stroke-fuchsia-400 transition-colors duration-300" />
                      
                      <motion.text 
                        animate={{ y: [0, -4, 0] }}
                        transition={{ repeat: Infinity, duration: 2.5, ease: "easeInOut" }}
                        x="20" y="55" fill="#F472B6" fontSize="14" fontFamily="monospace" fontWeight="bold">&lt;code&gt;</motion.text>
                      
                      <motion.text 
                        animate={{ y: [0, 4, 0] }}
                        transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                        x="135" y="65" fill="#34D399" fontSize="16" fontFamily="monospace" fontWeight="bold">&#123; ... &#125;</motion.text>
                      
                      <motion.text 
                        animate={{ y: [0, -3, 0] }}
                        transition={{ repeat: Infinity, duration: 2.8, ease: "easeInOut", delay: 0.5 }}
                        x="25" y="115" fill="#F59E0B" fontSize="12" fontFamily="monospace" fontWeight="bold">JS</motion.text>
                      
                      <motion.text 
                        animate={{ y: [0, 3, 0] }}
                        transition={{ repeat: Infinity, duration: 2.6, ease: "easeInOut", delay: 0.3 }}
                        x="150" y="115" fill="#60A5FA" fontSize="12" fontFamily="monospace" fontWeight="bold">React</motion.text>
                    </svg>
                  </motion.div>
                </div>
              </div>
